...
import placements from "./placements.png";
import innerGrowth from "./inner-growth.png";
import colors from "./colors.png";

import Video from "@components/mdx/Video.astro";
import vid1 from "./010.mp4";

<Image src={thumb} alt="24 minted tokens from Growth One" />
...
<Image
  src={placements}
  alt="From left: Token #5 with random seed nodes placement; Token #7 with horizontal placement; Token #10 with circular placement"
/>
...
<Image
  src={innerGrowth}
  alt="Examples of inner growth. From left: Token #9 and #13"
/>
...
<Image
  src={colors}
  alt="Colors are different based on seeds and generations. From left: Token #4, #17, and #23"
/>
