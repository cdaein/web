...
title: "Posting Web"
slug: posting-web
description: "Schedule and forget"
date: 2026-01-18
category: tool
tags:
  - app
...
<GC start={3} end={11} lgStart={3} lgEnd={11} class="mb-12">
  <Video src={vid1} poster={vid1poster} width="1280" height="720" />
</GC>

Posting Web improves upon [Posting](/posting) app that I created in 2024 by now running on a remote server 24/7 and adding the web interface for better usability.
...
<GC start={3} end={11} lgStart={4} lgEnd={10} class="">
