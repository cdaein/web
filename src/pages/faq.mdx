...
I use my own creating coding tool called [Ssam.js](https://github.com/cdaein/ssam). Another tool that I use a lot is [Thing Umbrella](https://github.com/thi-ng/umbrella). I like to keep my code modular for reusability and maintainability, and created a collection of small NPM packages that I always use for math, geometry, animation, etc.
