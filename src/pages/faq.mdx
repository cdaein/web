...
Here are answers to commonly asked questions. I get questions a lot through DM or email. I appreciate your interests in my work and process, but it does take time to answer them individually. If I answer you privately, I will only reach one person, but by writing here, I can reach more people. This post is updated from time to time.

### What softwares do you use?

All my personal works are created with code. I only use GUI-based softwares (ie. Adobe) when work requires or for retouching and editing for presentation, but I am using these pre-packaged solutions less and less. I use the JavaScript programming language (and sometimes, GLSL shading language) to create almost all my work.

### What programming language/libraries do you use?

I use my own creative coding tool called [Ssam.js](https://github.com/cdaein/ssam). Another tool that I use a lot is [Thing Umbrella](https://github.com/thi-ng/umbrella). I like to keep my code modular for reusability and maintainability, and created [a collection of small NPM packages](https://www.npmjs.com/~daeinc) that I always use for math, geometry, animation, etc.
